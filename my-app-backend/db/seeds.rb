...
Artwork.create(
    title: "Self-Portrait",
    description: "In this particular work, the focus is on Warhol's head and wig (one of dozens he wore over the years). By using repetitive images, each slightly different to the next, and then overlapping the images, Warhol produces the illusion of movement. Created towards the end of his life, Self-Portrait displays the artist in his signature wig, and also makes dramatic use of shadow and light.",
...
Artwork.create(
    ...
    description: "Warhol's religiosity is most exemplified by the late works that he created based on Leonardo Da Vinci's The Last Supper (1495–1498). Warhol based his works on a black and white photograph of a popular 19th century engraving and ended up producing over a hundred drawings, paintings, and silkscreens of the Renaissance masterpiece. From superimposing brand names over the faces of the apostles, to cutting up the unity of the scene, Warhol honored the original painting while adding it into his business enterprise.",
    medium: "Synthetic polymer paint and silkscreen ink on canvas",
    price: rand(10000..100000),
    year_created: 1986,
...
Artwork.create(
    title: "Brillo Boxes",
    description: "Still using the silkscreen technique, this time on plywood, Warhol presented the viewer with exact replicas of commonly used products found in homes and supermarkets. This time, his art pieces are stackable, they are sculptures that can be arranged in various ways in the gallery - yet each box is exactly the same, one is no better than another. Rather than the series of slightly different paintings that have been made by many famous artists Warhol makes the point that these products are all the same and they are beautiful! Making these items in his 'factory' Warhol again makes fun of the art world and the artist-creator.",
...
Artwork.create(
    ...
    description: "Seated Ballerina forms Part of Koons' Antiquity series, which fuses imagery and techniques from ancient and modern art. Koons envisioned the piece to be a contemporary interpretation of the mythical Roman Goddess, Venus. A common trope in ancient and classical art, Koons notes that, 'You could be looking at a Venus of Willendorf or some of the oldest Venuses. It is really about beauty and even a sense of contemplation, a sense of ease.' The dancer's pose is reminiscent of a traditional depiction of Venus, rooting the figure in historical precedent, but it is also visibly contemporary, merging past and present. Based on a small porcelain figurine by the Ukrainian artist, Oksana Zhnikrup, who produced a range of similar designs for factory production in the Soviet Union, Koons has scaled the image up to create a larger-than-life rendering in futuristic color-coated steel. In doing so, he revisits questions about art, industrial production and mass market appeal, a discussion that is particularly applicable to his own practice, in which multiple copies of the same work are created by industrial processes. The reflective surface of the piece allows the viewer to see themselves in the sculpture.",
    medium: "Mirror-polished stainless steel with transparent color coating",
    price: rand(10000..100000),
    year_created: 2017,
